...
/// public anon/publishable key, and every sensitive operation is a call to
/// an Edge Function (see
/// `packages/setu_core/lib/src/region/region_config_client.dart` for the
/// pattern).
